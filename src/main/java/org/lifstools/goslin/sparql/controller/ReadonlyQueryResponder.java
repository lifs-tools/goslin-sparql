...
@Experimental
@RestController
public class ReadonlyQueryResponder {

    private static final Logger log = LoggerFactory.getLogger(ReadonlyQueryResponder.class);
    ...
    @Autowired
    public ReadonlyQueryResponder(Repository repository) {
    ...
    private void doSparql(HttpServletRequest request, String query, String acceptHeader, String defaultGraphUri,
        ...
        try (RepositoryConnection connection = repository.getConnection()) {
            ...
            log.error("Malformed query or mismatching accept header!", mqe);
    ...
    /**
     * @see <a href="https://www.w3.org/TR/sparql11-protocol/#dataset">protocol
     * dataset</a>
     * @param q the query
    ...
    private enum QueryTypes {
        ...
        QueryTypes(Predicate<Query> typeChecker, FileFormat... formats) {
            ...
            log.info("Supported file formats: {}", formats);
        }

        /**
         * Test if the query is of a type that can be answered. And that the
         * accept headers allow for the response to be send.
         *
         * @param preparedQuery
         * @param acceptHeader
